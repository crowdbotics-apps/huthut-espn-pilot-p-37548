...
## Project Structure
    ...
    ├── huthut_espn_pilot_p_37548  # Django project configurations
...
1. Clone this repo and `cd huthut_espn_pilot_p_37548`
...
2. Clone this repo and `cd huthut_espn_pilot_p_37548`
